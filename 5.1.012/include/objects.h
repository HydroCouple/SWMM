...
////----------------------------
//// EXFILTRATION OBJECT moved from exfil.h
////----------------------------
//typedef struct
//{
//    TGrnAmpt*  btmExfil;
...
//-----------------------------------------------------------------------------
// Data Structures moved from control.c
//-----------------------------------------------------------------------------
...
// Rule Premise Clause
typedef struct TPremise
{
    int     type;                 // clause type (IF/AND/OR)
    TVariable lhsVar;     // left hand side variable                   //(5.1.008)
    TVariable rhsVar;     // right hand side variable                  //(5.1.008)
...
typedef struct
{
    ...
    TPremise* firstPremise;    // pointer to first premise of rule
    TPremise* lastPremise;     // pointer to last premise of rule
    TAction*  thenActions;     // linked list of actions if true
    TAction*  elseActions;     // linked list of actions if false
}TRule;

//-----------------------------------------------------------------------------
//  Data Structures moved from dynwave.c
//-----------------------------------------------------------------------------
typedef struct
{
