...
//
{
    ...
    project->Fumax = infil->IMDmax * infil->Lu * sqrt(project->Adjust.hydconFactor);             //(5.1.011)
...
//
{
    ...
    double lu = infil->Lu * sqrt(project->Adjust.hydconFactor);                         //(5.1.011)
    ...
    if ( ia == 0.0 )
    {
        ...
        kr = lu / 90000.0 * project->Evap.recoveryFactor;                               //(5.1.011)
        ...
        if ( infil->T <= 0.0 )
        {
            infil->IMD = (project->Fumax - infil->Fu) / lu;                             //(5.1.011)
            infil->F = 0.0;
        }
        return 0.0;
    }
    ...
    infil->T = 5400.0 / lu / project->Evap.recoveryFactor;                              //(5.1.011)
