...
//   - Imported variable project->project->HasWetLids now properly initialized.
...
//extern char       project->project->HasWetLids;          // TRUE if any LIDs are wet             //(5.1.010)
...
static int    addLidUnit(Project *project, int j, int k, int n, double x[], char* fname,
...
////  Modified for release 5.1.008.  ////                                      //(5.1.008)
    {
        ...
        report_writeErrorMsg(ERR_LID_PARAMS, project->Msg);
    }
*/
////
...
//
{
    ...
    lidproc_saveResults(project, lidUnit, UCF(project, RAINFALL), UCF(project, RAINDEPTH));               //(5.1.011)
...
//
{
    ...
    static char* head2[] = {
        "\n                    \t", "     Time\t",
        "   Inflow\t", "     project->Evap\t", "    Infil\t", "     Perc\t", "     Perc\t",
