...
double mathexpr_eval(Project* project, MathExpr *expr, double (*getVariableValue)(Project*, int))
...
MathExpr * mathexpr_create(Project* project, char *formula, int (*getVar) (Project*, char *))
{
    ExprTree *tree;
    MathExpr *expr = NULL;
