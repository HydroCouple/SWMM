...
//  output_readproject->SubcatchResults    (called by report_Subcatchments)
//  output_readproject->NodeResults        (called by report_Nodes)
//  output_readproject->LinkResults        (called by report_Links)
...
//
{
//    extern TRoutingTotals project->StepFlowTotals;  // defined in massbal.c
    int j;
