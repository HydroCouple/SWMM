...
//
{
  ...
  if ( k < 0 )
    return error_setInpError(ERR_KEYWORD, s1);
  switch ( k )
  {
...
//
{
  ...
  project->MinSlope        = 0.0;              // No user supplied minimum conduit slope //(5.1.012)
  ...
  project->NumEvents       = 0;                // Number of detailed routing events    //(5.1.011)
...
//
{
  ...
  project->Event = (TEvent *) calloc(project->NumEvents+1, sizeof(TEvent));
  project->Event[project->NumEvents].start = BIG;
  project->Event[project->NumEvents].end = BIG + 1.0;
  ////
...
//=============================================================================
>>>>>>> 6051eac9ba2f072ce8dca3ed68ebf9dde415b27a
